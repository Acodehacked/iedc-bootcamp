...
import { BsDiscord, BsFacebook, BsInstagram, BsLinkedin, BsX, BsYoutube } from 'react-icons/bs';
    ...
    return (
        <nav className='flex p-0 border-b-[0.01rem] border-zinc-200 justify-between fixed left-0 right-0 top-0 z-[999] bg-white items-center screen'>
            ...
            <div className='flex items-center'>
                ...
                <button onClick={() => toggleOpen()} className='w-[90px] flex justify-center hover:bg-zinc-100 items-center h-[90px]'><Image alt='' src={'/Menu.png'} width={400} height={400} className='w-[50]' /></button>
            </div>
            <AnimatePresence>
                {isOpen && <motion.nav
                    exit={'closed'}
                ...
                >
                    ...
                    <div className='p-10 flex flex-col  h-full justify-evenly'>
                        <div className="flex justify-end">
                            <button onClick={() => toggleOpen()} className='flex items-center bg-secondary rounded-full px-5 py-2'>
                        ...
                        <div className="follow">
                            <h2>Follow us on</h2>
                            <div className="flex text-secondary-foreground/30 text-4xl gap-2">
                                <BsLinkedin />
                                <BsInstagram />
                                <BsX />
                                <BsFacebook />
